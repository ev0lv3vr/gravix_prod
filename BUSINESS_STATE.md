...
- Latest completed ads folder: **2026-05-20**; 2026-05-21 pull started at **2026-05-22 06:00 PT** and was still running at the 8:56 AM heartbeat. Campaigns completed, but keywords were stuck in slow Amazon `PENDING`/timeout fallback polling after transient polling failures; token refresh succeeded and no durable auth failure had surfaced. Last valid completed metrics remain the 2026-05-20 pull: **$82.84 spend / $221.46 sales / 37.4% ACoS / 2.67× ROAS**, with **10 campaigns**, **91 keywords**, and **51 search terms**. Digest status was **OK — acceptable performance**; `CA Glue Core Exact`, `2oz thick and 8oz medium - keywords`, and `8oz Medium Auto` were winners, while `8oz Thick Auto` and `8oz Medium Glue - keywords` had spend with zero attributed sales. On **2026-05-07 6:30 PM PT**, after Ev approved the first conservative growth batch, Amazon Ads API accepted **20 campaign-level negative exacts**, **12 proven exact keyword bid raises (~10%)**, and **+10% budget bumps** on four winner campaigns: `Discovery - 8oz Thick Auto` **$60→$66**, `Sales - CA Glue Core Exact` **$50→$55**, `Discovery - 8oz Medium Auto` **$50→$55**, and `Sales - Thin CA Glue` **$35→$38.50**. Execution log: `moneysamurai/reports/ads-master-actions-execution-latest.json`. Monitor the 2026-05-21 pull to completion before any second scaling wave. Prior 2026-05-04 recovery remains resolved; no current invalid-streak incident is open.
