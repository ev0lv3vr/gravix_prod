# Morning Actionability Desk — 2026-05-08

Generated: 2026-05-07 23:05 PDT

## Snapshot
- Active items scanned: **43**
- Access / token blockers: **6**
- Passive / watch-only items: **9**
- Stale date refs still active: **8**
- High-ranked but low-action items: **3**
...
- **#4 · urgent · score 48.0** — Needs authenticated access, token refresh, or direct account/security check before progress.
...
- **#6 · urgent · score 45.0** — Needs authenticated access, token refresh, or direct account/security check before progress.
...
- **#12 · urgent · score 36.0** — Needs authenticated access, token refresh, or direct account/security check before progress.
...
- **#28 · needs_ev · score 25.0** — Needs authenticated access, token refresh, or direct account/security check before progress.
...
- **#33 · in_progress · score 22.0** — Needs authenticated access, token refresh, or direct account/security check before progress.
...
- **#2 · needs_ev · score 53.0** — Useful context, but likely not first-block execution work.
...
- **#4 · urgent · score 48.0** — Useful context, but likely not first-block execution work.
  - Amazon account security check / Meta partner request — Amazon sent a password recovery notice tied to a reset attempt from **Chrome on macOS near Washington**. If this was not Ev, he should verify account security directly in Amazon, not through the email link. Facebook/Meta sent a Business Manager partner request from **“Join the Meta Agency Partner Program”**. Treat as suspicious unless Ev recognizes it; do not approve/share assets from email links. Source: `sales` msg **6141**. Sources: `gluemasters` msg **192139**, `sales` msg **6141**.
- **#9 · needs_ev · score 43.0** — Useful context, but likely not first-block execution work.
...
- **#12 · urgent · score 36.0** — Useful context, but likely not first-block execution work.
  - Amazon FBA unfulfillable removal — Amazon created automated unfulfillable FBA removal order **gZRKfHwQJb**. Completion notice later arrived confirming the removal request completed successfully; no immediate action remains unless Ev wants to review Seller Central removal settings/address/frequency. Sources: `gluemasters` msgs **192161**, **192366**.
- **#13 · urgent · score 36.0** — Useful context, but likely not first-block execution work.
...
- **#16 · urgent · score 34.85** — Useful context, but likely not first-block execution work.
...
- **#32 · needs_ev · score 23.0** — Useful context, but likely not first-block execution work.
  - **TikTok/Amazon influencer outreach** — low-priority vendor/influencer pitch surfaced late day; not urgent. Source msg **6066**.
- **#34 · needs_ev · score 15.0** — Useful context, but likely not first-block execution work.
...
- **#1 · urgent · score 60.18** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-04-30, 2026-04-25, 2026-04-30.
...
- **#2 · needs_ev · score 53.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-05-04.
  - **Gemifly LLC** — new PayPal invoice **1001-0243** for **$7,449.98** was sent to Gemifly LLC on 2026-05-04; track for payment. Earlier open amount listed was **$1,513.23**, now superseded by the new larger invoice unless Ev says otherwise. Source: `sales` msg **6134**.
- **#6 · urgent · score 45.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-04-30.
  - ICU Shopify upsell app token — In Cart Upsell says the store token expires **Thu 2026-04-30** and upsell offers will pause if the app is not opened/refreshed in Shopify admin. Source: `sales` msg **6090**.
- **#9 · needs_ev · score 43.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-05-06.
  - **Cute Things & Creative Concepts / Shohreh** — bulk quote is current; Shohreh asked whether they may sell Glue Masters products on **Amazon** after the $16,030.20 quote. Ev sent a reply on **2026-05-06** saying **no Amazon resale authorization**; wait for her response. Sources: `sales` msgs **6087**, **6100**, **6101**, **6149**.
- **#11 · needs_ev · score 38.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-05-03.
...
- **#33 · in_progress · score 22.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-05-02.
  - Heartbeat git-hygiene check on 2026-05-02 surfaced surprise local MoneySamurai repo changes: `api/trigger-sync.js` modified, new `api/get-auth-token.js`, and branch ahead of origin by **21 commits**. Inspect before any deploy-ish action.
- **#34 · needs_ev · score 15.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-04-27.
  - **Jeremy Embry / Aquarium Artisans** — Ev sent the pricing / “what do you want to do moving forward” reply on 2026-04-27; wait for Jeremy’s response before next action. Source thread: `sales` msg **6046**.
- **#35 · in_progress · score 14.0** — Contains past-dated reference; may need rewrite, confirmation, or demotion. Refs: 2026-05-05.
...
- **#2 · needs_ev · score 53.0** — Surfaced high in the ranked board despite weak immediate action signal. Refs: 2026-05-04.
  - **Gemifly LLC** — new PayPal invoice **1001-0243** for **$7,449.98** was sent to Gemifly LLC on 2026-05-04; track for payment. Earlier open amount listed was **$1,513.23**, now superseded by the new larger invoice unless Ev says otherwise. Source: `sales` msg **6134**.
- **#9 · needs_ev · score 43.0** — Surfaced high in the ranked board despite weak immediate action signal. Refs: 2026-05-06.
  - **Cute Things & Creative Concepts / Shohreh** — bulk quote is current; Shohreh asked whether they may sell Glue Masters products on **Amazon** after the $16,030.20 quote. Ev sent a reply on **2026-05-06** saying **no Amazon resale authorization**; wait for her response. Sources: `sales` msgs **6087**, **6100**, **6101**, **6149**.
- **#12 · urgent · score 36.0** — Surfaced high in the ranked board despite weak immediate action signal.
  - Amazon FBA unfulfillable removal — Amazon created automated unfulfillable FBA removal order **gZRKfHwQJb**. Completion notice later arrived confirming the removal request completed successfully; no immediate action remains unless Ev wants to review Seller Central removal settings/address/frequency. Sources: `gluemasters` msgs **192161**, **192366**.
