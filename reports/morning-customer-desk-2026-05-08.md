# Morning Customer Desk — 2026-05-08
...
- Visible money in queue: **$23,537.02**
...
- **Garcor / Kyle Lawson** — sent attached purchase order **PO4046132.pdf** and asked us to process it and confirm receipt. Source: `gluemasters` msg **192403**. (msgs 192403)
...
- **John L Ortman** — Shopify contact form asks whether **Ultra Thin** will be offered in a small-format size; website says it is available but no purchase option is visible. Source: `sales` msg **6174**. (msgs 6174)
