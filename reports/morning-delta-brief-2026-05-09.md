...
## Big rank moves
- **#20** from #30 (+10) · John L Ortman — Shopify contact form asks whether Ultra Thin will be offered in a small-format size; website says it is available but no purchase option is visible. Midday 2026-05-08 check found mixed evidence: current shopping/feed + B2B collateral only expose Ultra Thin 16oz, but internal SKU/cost references also mention GM8OZ5CPS and GM2OZ5CPS. Real blocker is product truth: confirm whether 8oz/2oz Ultra Thin are actually sellable/live before replying. Source: sales msg 6174.
