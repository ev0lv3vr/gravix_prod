...
from routers import health, analyze, specify, users, cases, reports, billing, stats, feedback, cron, admin, investigations, comments, notifications, templates, email_inbound, products, guided, patterns, pricing, auth_test
...
app.add_middleware(
    ...
    # Allow all Vercel preview subdomains while preserving explicit production origins.
...
app.include_router(investigations.api_router)
app.include_router(comments.router)
app.include_router(comments.api_router)
app.include_router(notifications.router)
app.include_router(templates.router)
app.include_router(email_inbound.router)
app.include_router(email_inbound.api_router)
