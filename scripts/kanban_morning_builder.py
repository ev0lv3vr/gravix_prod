...
def render_ops_hub_html(report: BuildOutput) -> str:
    ...
    links = [
        ...
        ("Deadline Control Desk (latest)", "./deadline-control-desk-latest.html"),
        ("Supplier Ops Desk (latest)", "./supplier-ops-desk-latest.html"),
        ("Order Ops Closure Desk (latest)", "./order-ops-desk-latest.html"),
        ("Order Ops Handoff CSV (latest)", "./order-ops-handoff-latest.csv"),
